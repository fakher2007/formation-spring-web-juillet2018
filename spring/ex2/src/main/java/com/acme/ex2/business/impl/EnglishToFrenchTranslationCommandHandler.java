...
public class EnglishToFrenchTranslationCommandHandler implements CommandHandler<TranslationCommand> {
    ...
    public void handle(TranslationCommand command) {
        ...
        // (1) traitement sémantique, syntaxique (spécifique à une traduction en-fr), etc.. sur sentence
        // TODO 2) accès au référentiel des mots et récupération de la traduction de chaque mot traduit
